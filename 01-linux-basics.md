...
Document my first Linux commands and understand how to use the terminal for IT Support and Cybersecurity practice.
...
- Host machine: macOS
- Purpose: Learning Linux fundamentals in a safe lab environment
